...
function S03_Consumer({ motion }) {
  return (
    <section id="consumer" data-section="03" data-screen-label="03 Consumer" className="section-pad">
      <div className="page">
        <SectionTag n="03" title="Consumer robotics — the category I am not entering, and why" source="iRobot S-1, Roborock IR, Anker filings, Goldman Sachs SUMMIT 2025"/>

        <div className="col-12">
          <Reveal style={{ gridColumn: '1 / span 7' }}>
            <h2 className="h2" style={{ marginBottom: 24 }}>
              Consumer robotics is real. It is also the <em style={{ color: 'var(--accent)' }}>wrong starting point</em> from India.
            </h2>
            <p className="lead">
              The last three years fragmented consumer robotics into a dozen workable archetypes — vacuum,
              lawn, pool, window, cooking, eldercare. Each solves one chore for under <Gloss term="$2,000 ceiling" def="The empirical price ceiling above which consumer robot SKUs convert at less than 0.5% — derived from Roborock and Anker channel data.">a $2,000 ceiling</Gloss>.
              It is a shelf, not a category. But for an Indian builder it is the worst place to start:
              you compete with Roborock and Ecovacs on hardware cost, on Amazon/Flipkart shelf placement,
              on returns logistics, and on YouTube unboxing reviews — four games where India has no edge
              and no moat. The category exists; it just isn't ours to take from a standing start.
            </p>
          </Reveal>
        ...
        {/* Explicit 'what I'm not doing' callout */}
        <Reveal>
          <div className="panel" style={{ borderLeft: '3px solid var(--accent)' }}>
            <Kicker>Why this is not the bet</Kicker>
            <h3 className="h3" style={{ margin: '12px 0 14px' }}>Four reasons consumer is the wrong opening move from India.</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 18 }}>
              {[
                ['Hardware cost is set in Shenzhen', 'Indian BOM for a vacuum or lawn bot lands 20–35% higher than Chinese-OEM imports. We cannot win on price.'],
                ['Distribution = retail shelf', 'Amazon/Flipkart shelf placement is a paid game. No first-time hardware brand wins it without a $10–20M marketing burn.'],
                ['Returns + after-sales = brand killer', 'Indian consumer hardware brand failures (Boat misses, Noise, etc.) almost always die on RMA economics, not on the product.'],
                ['No data flywheel', 'A vacuum collects floor maps. A factory cobot collects parts-pose data that compounds into a moat. Consumer telemetry mostly does not.']
              ].map(([t, b], i) => (
                <div key={i}>
            ...
            <div style={{ fontSize: 14, color: 'var(--ink-mid)' }}>
              <span style={{ color: 'var(--accent)' }}>Conclusion: </span>
              cute consumer robots are a real business — for an existing distribution-first
              consumer brand. They are not how we should walk in. The B2B equivalent of every
              point above flips in our favour. That's Section 04.
            </div>
          </div>
        </Reveal>
        ...
        <Reveal>
          <VideoReel
            ...
            sub="6 videos · so we know exactly what we are not building"
            items={[
      ...
      <div className="page">
        ...
        <Reveal>
          <VideoReel
            ...
            items={[
              { label: 'FANUC lights-out factory — robots making robots', source: 'YouTube', url: 'https://www.youtube.com/watch?v=vIhEKoS2Bjc' },
              { label: 'Symbotic — building the future of warehouse automation', source: 'YouTube · Symbotic', url: 'https://www.youtube.com/watch?v=v27JFsRtEI8' },
              { label: 'Why Symbotic is dominating warehouse automation', source: 'YouTube', url: 'https://www.youtube.com/watch?v=nZs77mzu2_k' },
              { label: 'Locus Robotics — autonomous picking warehouse analysis', source: 'YouTube', url: 'https://www.youtube.com/watch?v=lAu9qmsVRm0' },
              { label: 'Universal Robots welding cobot — plug-and-play', source: 'YouTube · WeCobot', url: 'https://www.youtube.com/watch?v=vKynS6bDilg' },
              { label: 'FANUC No. 1 in factory automation worldwide', source: 'YouTube', url: 'https://www.youtube.com/watch?v=EcpTRU4GiuY' }
            ]}/>
        </Reveal>
      </div>
    </section>
      ...
      <div className="page">
        ...
        <Reveal>
          <VideoReel
            ...
            sub="7 videos · every form factor, Indian-built where possible"
            items={[
              { label: 'Ati Motors Sherpa — AMR factory walkthrough (Bangalore)', source: 'YouTube · Ati Motors', url: 'https://www.youtube.com/watch?v=xz1dkqCjg8I' },
              { label: 'Ati Motors Sherpa — full product portfolio', source: 'YouTube · Ati Motors', url: 'https://www.youtube.com/watch?v=Qkzp0E47Ue4' },
              { label: 'Niqo RoboSpray — AI agri spraying (India-built)', source: 'YouTube · Niqo Robotics', url: 'https://www.youtube.com/watch?v=RvwfLtqa8XU' },
              { label: 'Niqo AI spot spray — as featured on BBC', source: 'YouTube · BBC', url: 'https://www.youtube.com/watch?v=Sap3Z-9vSow' },
              { label: 'Locus Robotics — autonomous picking analysis', source: 'YouTube', url: 'https://www.youtube.com/watch?v=lAu9qmsVRm0' },
              { label: 'Locus Robotics — how it works', source: 'YouTube · Locus', url: 'https://www.youtube.com/watch?v=MDKPRkcknRA' },
              { label: 'Universal Robots cobot welding — plug-and-play', source: 'YouTube · WeCobot', url: 'https://www.youtube.com/watch?v=vKynS6bDilg' }
            ]}/>
        </Reveal>
